...
export default function Navbar(){
    ...
    return(
        ...
        <div className="flex lg:gap-20 lg:items-center lg:p-5 lg:ml-5">
         ...
         <p className="text-sm ml-7 text-black">I want to</p>
         <div className="flex items-center gap-3">
         <p className="border h-4 w-4 rounded-full bg-red-400"></p>
         <Link href={"/components/buy"}><span className="text-2xl text-black hover:text-red-400">Buy +</span></Link>
         </div>
         </div>
         ...
         <Link href={"/components/rent"}><span className="text-2xl text-black hover:text-blue-700">Rent +</span></Link>
         </div>
         </div>
        ...
        <Link href={"/components/sell"}><span className="text-2xl text-black hover:text-orange-400 ">Sell +</span></Link> 
         </div>
         </div>
         </div>
         </div>
         <p className="text-2xl text-black mt-7 lg:mt-0  lg:mr-15">Jimoh Sherif / Real Estate <br/><span className="text-sm">Tel: 09030501762</span></p>
         </div>
         ...
         <div className="flex items-center gap-3">
         <p className="border h-4 w-4 rounded-full bg-red-400"></p>
        <Link href={"/components/buy"}><span className="text-2xl text-black">Buy +</span></Link> 
         </div>
         </div>
          <div className="border-r w-30 ml-2">
         <p className="text-sm ml-7 text-black">I want to</p>
         <div className="flex items-center gap-3">
         <p className="border h-4 w-4 rounded-full bg-blue-700"></p>
         <Link href={"/components/rent"}><span className="text-2xl text-black">Rent +</span></Link>
         </div>
         </div>
          <div className="border-r w-25 ml-2">
         <p className="text-sm ml-7 text-black">I want to</p>
         <div className="flex items-center gap-3">
         <p className="border h-4 w-4 rounded-full bg-orange-400"></p>
         <Link href={"/components/sell"}><span className="text-2xl text-black">Sell +</span></Link>
         </div>
         </div>
         </div>
         <div
